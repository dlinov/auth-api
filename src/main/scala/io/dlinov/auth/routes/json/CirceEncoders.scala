...
object CirceEncoders extends CirceConfigProvider {
  ...
  implicit final val errorParamsEncoder: Encoder.AsObject[ErrorParams] = deriveConfiguredEncoder[ErrorParams]
  implicit final val apiErrorEncoder: Encoder.AsObject[ApiError] = deriveConfiguredEncoder[ApiError]

  implicit final val scopeToCreateEncoder: Encoder.AsObject[ScopeToCreate] = deriveConfiguredEncoder[ScopeToCreate]
  implicit final val scopeToReadEncoder: Encoder.AsObject[ScopeToRead] = deriveConfiguredEncoder[ScopeToRead]
  implicit final val scopeToUpdateEncoder: Encoder.AsObject[ScopeToUpdate] = deriveConfiguredEncoder[ScopeToUpdate]

  implicit final val roleToCreateEncoder: Encoder.AsObject[RoleToCreate] = deriveConfiguredEncoder[RoleToCreate]
  implicit final val roleToReadEncoder: Encoder.AsObject[RoleToRead] = deriveConfiguredEncoder[RoleToRead]
  implicit final val roleToUpdateEncoder: Encoder.AsObject[RoleToUpdate] = deriveConfiguredEncoder[RoleToUpdate]
  ...
  implicit final val permissionToCreateEncoder: Encoder.AsObject[PermissionToCreate] = deriveConfiguredEncoder[PermissionToCreate]
  implicit final val permissionToReadEncoder: Encoder.AsObject[PermissionToRead] = deriveConfiguredEncoder[PermissionToRead]
  implicit final val permissionToUpdateEncoder: Encoder.AsObject[PermissionToUpdate] = deriveConfiguredEncoder[PermissionToUpdate]
  ...
  implicit final val passwordResetClaimEncoder: Encoder.AsObject[PasswordResetClaim] = deriveConfiguredEncoder[PasswordResetClaim]
  ...
  implicit final val passwordResetEncoder: Encoder.AsObject[PasswordReset] = deriveConfiguredEncoder[PasswordReset]

  implicit final val emailEncoder: Encoder[Email] = Encoder.encodeString.contramap[Email](_.value)
  implicit final val credentialsToReadEncoder: Encoder.AsObject[CredentialsToRead] = deriveConfiguredEncoder[CredentialsToRead]
  implicit final val credentialsToUpdateEncoder: Encoder.AsObject[CredentialsToUpdate] = deriveConfiguredEncoder[CredentialsToUpdate]
  implicit final val claimContentEncoder: Encoder.AsObject[ClaimContent] = deriveConfiguredEncoder[ClaimContent]
  implicit final val loginResponseEncoder: Encoder.AsObject[LoginResponse] = deriveConfiguredEncoder[LoginResponse]
  implicit final val loginStatusResponseEncoder: Encoder.AsObject[LoginStatusResponse] = deriveConfiguredEncoder[LoginStatusResponse]

  implicit final val healthInfoEncoder: Encoder.AsObject[HealthInfo] = deriveConfiguredEncoder[HealthInfo]

  implicit final val documentToReadEncoder: Encoder.AsObject[DocumentToRead] = deriveConfiguredEncoder[DocumentToRead]
