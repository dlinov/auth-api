...
import io.dlinov.auth.routes.dto.{BackOfficeUserToRead, BusinessUnitToRead, CollectionResponse, Document, DocumentToRead, PermissionBlueprint, PermissionToCreate, PermissionToRead, RoleToRead, ScopeToRead, WrappedId}
